    ...
    return (
        <>
            {user ? (
                <div className="mr-2 lg:mr-0 dropdown relative">
                    ...
                    >
                        ...
                        <span className="ml-2 hidden text-left md:block ">
                            ...
                            <span className="-mt-1 block text-xl font-medium text-gray-900 dark:text-white">
                                {user.firstName}
                            </span>
                        </span>
                    </button>
                ...
                <Link href={`${baseUrl}/login`} className=" p-3 font-medium hover:bg-accentOne to-accentTwo">Login/Register</Link>
